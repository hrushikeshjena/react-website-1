      ...
      <div className="setence-drs-h">
        ...
        <div className="sentence-dr-h">
          ...
          <div className="designcard">
            ...
            >
              <div className="fs-6 fs-6-b fw-light w-75 mx-5 arr-hov-p hov-p">
             <p>   Give your salespeople the edge they need to accelerate
                productivity and sales performance. Orive Solutions ERP rovides
                a 360 degree view of their customer and go from quote to cash
                effortlessly Quick access to information concerning products,
                price lists, discounts, and transporter. Issue customer
                quotations, book orders, transmit order acknowledgements, manage
                contracts, view and allocate goods from stock, and manage the
                dispatch and invoicing of goods. Advanced features for Inventory
                enquiries and allocations, Brokerage Sales commissions,
                Multi-level credit control , Pricing and discounts, Customer
                returns, Invoicing and reminders
                </p> </div>
              <div className="fs-6-b mx-5 mb-3 arr-hov">
                <img src={ArrowHover} height={80} alt="" />
              </div>
          ...
          <div className="designcard">
            ...
            >
              <div className="fs-6 fs-6-b fw-light w-75 mx-5 arr-hov-p hov-p">
              <p> Seamlessly manage the purchasing process from purchase requests,
                orders, deliveries, subcontract orders. approval process from
                order through receipt and invoicing. Orive Solutions ERP has
                multi-site, multi-warehouse and multi-location management with
                total traceability of inventory quantities and lot and batch
                numbers. Advanced features for Supplier and product
                classification, Pricing and discounts, tolerances, inventory
                balances and reorder level, lead days and stock movement.
                </p></div>
              <div className="fs-6-b mx-5 mb-3 arr-hov">
                <img src={ArrowHover} height={80} alt="" />
              </div>
          ...
          <div className="designcard">
            ...
            >
              <div className="fs-6 fs-6-b fw-light w-75 mx-5 arr-hov-p hov-p">
               <p> Gain real-time visibility into your operations with Orive
                Solutions ERP. Orive Solutions ERP supports planning,
                scheduling, and production control activities in detail for
                process manufacturing. From production planning (make to order/
                make to stock), process scheduling, production performance and
                costing. Advanced features for Bill of Material, formulas, and
                recipes, Production cost and plant Performances, Quality control
                & analysis. </p>
              </div>
              <div className="fs-6-b mx-5 mb-3 arr-hov">
                <img src={ArrowHover} height={80} alt="" />
          ...
          <div className="designcard">
            ...
            >
              <div className="fs-6 fs-6-b fw-light w-75 mx-5 arr-hov-p hov-p">
              <p> Orive Solutions pioneers ERP excellence with a focused Order
                ...
                Elevate your order processing capabilities with Orive Solutions'
                cutting-edge ERP
                </p> </div>
              <div className="fs-6-b mx-5 mb-3 arr-hov">
                <img src={ArrowHover} height={80} alt="" />
          ...
          <div className="designcard">
            ...
            >
              <div className="fs-6 fs-6-b fw-light w-75 mx-5 arr-hov-p hov-p">
                <p>Orive Solutions' ERP introduces a powerful Warehouse Management
                Module, revolutionizing logistical operations. Benefit from
                real-time inventory tracking, order fulfillment efficiency,
                barcode scanning integration, and intelligent space utilization.
                Experience heightened productivity, reduced operational costs,
                and enhanced accuracy. Seamlessly integrating with other ERP
                modules, this solution ensures a unified system for optimized
                business processes. Elevate your warehouse management with Orive
                Solutions ERP, a comprehensive tool designed for modern
                businesses seeking efficiency and a competitive edge.
                </p></div>
              <div className="fs-6-b mx-5 mb-3 arr-hov">
                <img src={ArrowHover} height={80} alt="" />
              </div>
